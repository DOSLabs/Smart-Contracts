    ...
    IERC1155ReceiverUpgradeable
{
    ...
    function mint(
        ...
        bytes32 msgEncode = keccak256(abi.encodePacked(to, id, none, amount));
        ...
        require(
            isSigner(signer) && getNonce(to) == none,
        ...
        emit UseSignature(to, id, none, amount, signature);
    }
}
