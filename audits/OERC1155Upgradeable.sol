...
contract OERC1155Upgradeable is ERC1155SupplyUpgradeable, ONFT1155CoreUpgradeable, IONFT1155Upgradeable {
    function __OERC1155Upgradeable_init(string memory uri_, address endpoint_) internal onlyInitializing {
    ...
    function _debitFrom(address _from, uint16, bytes memory, uint[] memory _tokenIds, uint[] memory _amounts) internal virtual override {
        ...
        require(spender == _from || isApprovedForAll(_from, spender), "OERC1155: send caller is not owner nor approved");
